...
export interface TrackWithParent {
  readonly node: RootTrack | Track;
  readonly parent?: TrackParent;
}

export interface TrackParent {
  readonly node: Track;
...
export function removeTrack(world: World, trackId: string): World {
  return produce(world, (draft) => {
...
export function flipTrack(world: World, trackId: string): World {
  return produce(world, (draft) => {
...
export function flipTrain(world: World, trainId: string): World {
  return produce(world, (draft) => {
...
export function removeTrain(world: World, trainId: string): World {
  return produce(world, (draft) => {
    draft.trains = draft.trains.filter((t) => t.id !== trainId);
  });
}

export function rotateTrain(
  world: World,
  trainId: string,
  direction: RotateDirection,
): World {
